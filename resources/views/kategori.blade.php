            ...
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-blue-800  rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <form enctype="multipart/form-data" class="space-y-6" action="/kategori/storeinput" method="post">
                            @csrf
                            <div>
                                <label for="nama"
                            ...
                            <div>
                                ...
                                <input type="text" name="deskripsi" id="deskripsiKategori"
                ...
                <tbody>
                    @foreach ($kategori as $b)
                        <tr
                            ...
                            <td class=" py-4 flex ">
                                <button type="button" data-modal-target="authentication-modal{{ $b->kategoriID }}"
                                    data-modal-toggle="authentication-modal{{ $b->kategoriID }}"
                                ...
                                <form class="inline-block" action="/kategori/delete/{{ $b->kategoriID }}" method="get">
                                    @csrf
                                    @method('delete')
                        ...
                        <div id="authentication-modal{{ $b->kategoriID }}" tabindex="-1" aria-hidden="true"
                            class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative w-full max-w-md max-h-full">
                                ...
                                <div class="relative bg-blue-700 rounded-lg shadow dark:bg-gray-700">
                                    <button type="button"
                                        class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                        data-modal-hide="authentication-modal{{ $b->kategoriID }}">
                                    ...
                                    <div class="px-6 py-6 lg:px-8">
                                        ...
                                        <form class="space-y-6" action="/kategori/storeupdate" method="post">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $b->kategoriID }}">
                                            <div>
                                                <label for="nama"
                                                    class="block mb-2 mt-2 text-sm font-medium text-slate-50 dark:text-white">Nama
                                                </label>
                                                <input type="text" value="{{ $b->namaKategori }}" name="nama"
                                                    id="namaKategori"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                                    required>
                                            </div>
                                            <div>
                                                ...
                                                <input type="text" value="{{ $b->deskripsiKategori }}"
                                                    name="deskripsi" id="deskripsiKategori"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                                    required>
                                                <button type="submit"
